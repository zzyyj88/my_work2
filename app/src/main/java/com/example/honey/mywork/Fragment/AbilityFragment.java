...
public class AbilityFragment extends android.support.v4.app.Fragment {

    private Button but;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //ac_fargment_a为fragment当前布局
        View view=inflater.inflate(R.layout.activity_ability_fragment,null);
        // 绑定该LinearLayout的ID
        but=(Button) view.findViewById(R.id.binei);
        // 设置监听
